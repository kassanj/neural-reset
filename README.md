...
Built with LangChain, LangSmith, and the Spotify API. Includes a safety layer that detects crisis language and gently exits the session with verified crisis resources.

## Stack

Python · LangChain · LangSmith · SpotifyAPI · OpenAI · FastAPI
